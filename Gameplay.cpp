...
void standardEnemy:: getNewWaypoint() // sets next point to move towards
{

}

void drawProjectiles() {
	for (int i = 0; i < projectileList.size(); i++) { //Go through each projecile in the list and draw them
